...
// zenacoin includes.
#include <..\src\script\zenacoinconsensus.h>
...
int main()
{
    std::cout << "zenacoinconsensus version: " << zenacoinconsensus_version() << std::endl;
    ...
    auto op0Result = zenacoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, zenacoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
