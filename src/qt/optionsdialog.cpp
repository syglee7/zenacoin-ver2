    ...
    mapper(nullptr)
{
    ...
    ui->zenacoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->zenacoinAtStartup);
    ...
    ui->zenacoinAtStartup->setToolTip(ui->zenacoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->zenacoinAtStartup->setText(ui->zenacoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openZenacoinConfButton->setToolTip(ui->openZenacoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ZenacoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->zenacoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openZenacoinConfButton_clicked()
{
