    ...
    platformStyle(_platformStyle)
{
    ...
    // normal zenacoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying zenacoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &ZenacoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
