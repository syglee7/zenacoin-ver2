...
//! Entry point for ZenacoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ZenacoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ZenacoinGUI tests.
void AppTests::guiTests(ZenacoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ZenacoinGUI::consoleShown, this, &AppTests::consoleTests);
