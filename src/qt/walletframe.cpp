...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, ZenacoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &ZenacoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &ZenacoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &ZenacoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &ZenacoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &ZenacoinGUI::updateWalletStatus);
    connect(gui, &ZenacoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
