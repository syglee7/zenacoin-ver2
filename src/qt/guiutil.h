...
#ifndef ZENACOIN_QT_GUIUTIL_H
#define ZENACOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Zenacoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "zenacoin:" URI into recipient object, return true on successful parsing
