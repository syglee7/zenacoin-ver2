...
#ifndef ZENACOIN_POLICY_FEERATE_H
#define ZENACOIN_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "ZNC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    ZNC_KVB,      //!< Use ZNC/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from ZNC/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::ZNC_KVB) const;

    SERIALIZE_METHODS(CFeeRate, obj) { READWRITE(obj.nSatoshisPerK); }
};

#endif //  ZENACOIN_POLICY_FEERATE_H
