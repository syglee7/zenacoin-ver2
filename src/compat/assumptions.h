...
#ifndef ZENACOIN_COMPAT_ASSUMPTIONS_H
#define ZENACOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Zenacoin cannot be compiled without assertions."
#endif
...
#endif // ZENACOIN_COMPAT_ASSUMPTIONS_H
