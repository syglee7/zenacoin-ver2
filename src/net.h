...
#ifndef ZENACOIN_NET_H
#define ZENACOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/zenacoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Zenacoin’s Peer-to-Peer Network")
