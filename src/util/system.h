 ...
 */
#ifndef ZENACOIN_UTIL_SYSTEM_H
#define ZENACOIN_UTIL_SYSTEM_H
...
extern const char * const ZENACOIN_CONF_FILENAME;
extern const char * const ZENACOIN_SETTINGS_FILENAME;
