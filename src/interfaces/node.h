...
#ifndef ZENACOIN_INTERFACES_NODE_H
#define ZENACOIN_INTERFACES_NODE_H
...
//! Top-level interface for a zenacoin node (zenacoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // ZENACOIN_INTERFACES_NODE_H
