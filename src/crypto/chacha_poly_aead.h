...
#ifndef ZENACOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define ZENACOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@zenacoin.
 *
 ...
 *
 * The chacha20-poly1305@zenacoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@zenacoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@zenacoin are relatively fast in
...
#endif // ZENACOIN_CRYPTO_CHACHA_POLY_AEAD_H
