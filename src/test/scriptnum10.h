...
#ifndef ZENACOIN_TEST_SCRIPTNUM10_H
#define ZENACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Zenacoin Core 0.10.0, for cross-comparison.
 */
public:
