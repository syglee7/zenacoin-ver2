...
{
    const char* pszTimestamp = "Blockchain by example 2021";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("0x000001b303c462ad76b76822c6e9db198fe9c144ebcbdb10f07ad83c7c9df201");
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1613910665; // December 31, 2008
        ...
        genesis = CreateGenesisBlock(1613910665, 1558696, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000001b303c462ad76b76822c6e9db198fe9c144ebcbdb10f07ad83c7c9df201"));
        assert(genesis.hashMerkleRoot == uint256S("0x2fd87711d7d18d4b79fe04cb1f5e375c5a80ab435c775c2bccb4b3fca0bd0fe9"));
       ...
       // vSeeds.emplace_back("seed.zenacoin.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
       // vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
       // vSeeds.emplace_back("dnsseed.zenacoin.dashjr.org"); // Luke Dashjr
       // vSeeds.emplace_back("seed.zenacoinstats.com"); // Christian Decker, supports x1 - xf
       // vSeeds.emplace_back("seed.zenacoin.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
       // vSeeds.emplace_back("seed.znc.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
       // vSeeds.emplace_back("seed.zenacoin.sprovoost.nl"); // Sjors Provoost
       // vSeeds.emplace_back("dnsseed.emzy.de"); // Stephan Oeste
       // vSeeds.emplace_back("seed.zenacoin.wiz.biz"); // Jason Maurice
...
public:
    CTestNetParams() {
       ...
       // vSeeds.emplace_back("testnet-seed.zenacoin.jonasschnelli.ch");
       // vSeeds.emplace_back("seed.tznc.petertodd.org");
       // vSeeds.emplace_back("seed.testnet.zenacoin.sprovoost.nl");
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        if (!args.IsArgSet("-signetchallenge")) {
            ...
            vSeeds.emplace_back("v7ajjeirttkbnt32wpy3c6w3emwnfr3fkla7hpxcfokr3ysd3kqtzmqd.onion:39333");
