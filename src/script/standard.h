...
#ifndef ZENACOIN_SCRIPT_STANDARD_H
#define ZENACOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a zenacoin address
 */
...
/**
 * Generate a Zenacoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // ZENACOIN_SCRIPT_STANDARD_H
