...
#ifndef ZENACOIN_WALLET_WALLET_H
#define ZENACOIN_WALLET_WALLET_H
...
public:
     ...
     * on this zenacoin node, and set to 0 for transactions that were created
...
#endif // ZENACOIN_WALLET_WALLET_H
