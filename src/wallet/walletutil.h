...
#ifndef ZENACOIN_WALLET_WALLETUTIL_H
#define ZENACOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! zenacoin from opening the wallet, thinking it was newly created, and
...
#endif // ZENACOIN_WALLET_WALLETUTIL_H
