...
#ifndef ZENACOIN_WALLET_SCRIPTPUBKEYMAN_H
#define ZENACOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Zenacoin Core wallet was originally a collection of unrelated private
...
#endif // ZENACOIN_WALLET_SCRIPTPUBKEYMAN_H
