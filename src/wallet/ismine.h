...
#ifndef ZENACOIN_WALLET_ISMINE_H
#define ZENACOIN_WALLET_ISMINE_H
 ...
 * https://github.com/zenacoin/zenacoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // ZENACOIN_WALLET_ISMINE_H
