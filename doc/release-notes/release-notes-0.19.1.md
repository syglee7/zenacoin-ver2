...
Zenacoin Core version 0.19.1 is now available from:

  <https://zenacoincore.org/bin/zenacoin-core-0.19.1/>
...
From Zenacoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Zenacoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Zenacoin Core does not yet change appearance when
...
- #17488 fix "zenacoind already running" warnings on macOS (fanquake)
