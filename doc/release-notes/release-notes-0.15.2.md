Zenacoin Core version *0.15.2* is now available from:

  <https://zenacoincore.org/bin/zenacoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in zenacoin-tx (TheBlueMatt)
