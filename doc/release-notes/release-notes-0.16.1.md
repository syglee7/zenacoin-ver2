Zenacoin Core version 0.16.1 is now available from:

  <https://zenacoincore.org/bin/zenacoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting zenacoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure zenacoind processes are cleaned up when tests end (sdaftuar)
