...
This document provides guidelines for internationalization of the Zenacoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `zenacoin_en.ts` remains unchanged.
