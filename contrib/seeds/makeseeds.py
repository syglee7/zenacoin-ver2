...
def main():
    ...
    # Filter out hosts with multiple zenacoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple zenacoin ports' % (ip_stats(ips)), file=sys.stderr)
