...
zenacoincore.org and zenacoin.org and compares them.
...
WORKINGDIR = "/tmp/zenacoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://zenacoincore.org"
HOST2 = "https://zenacoin.org"
VERSIONPREFIX = "zenacoin-core-"
...
def main(args):
    ...
    if not success:
        print("zenacoin.org failed to provide signature file, "
              "but zenacoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("zenacoin.org and zenacoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Zenacoin Core binary release "
