# Bootstrappable Zenacoin Core Builds

This directory contains the files necessary to perform bootstrappable Zenacoin
Core builds.
...
- 24GB of free disk space on the partition that the Zenacoin Core git repository
  resides in
...
From the top of a clean Zenacoin Core repository:
...
To use dongcarl's substitute server for Zenacoin Core builds after having
