...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the zenacoin repository."
  exit 1
fi
...
# See https://github.com/zenacoin/zenacoin/issues/16064
...
echo 'When compiling zenacoind, run `./configure` in the following way:'
echo
