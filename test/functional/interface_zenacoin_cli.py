...
# The block reward of coinbaseoutput.nValue (50) ZNC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 ZNC/block.
BLOCKS = 101
...
class TestZenacoinCli(ZenacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `zenacoin-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and zenacoin-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 ZNC) to the default wallet.
            ...
            # Test zenacoin-cli -generate with -rpcwallet in multiwallet mode.
