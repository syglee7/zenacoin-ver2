...
By default, zenacoind will dump mempool on shutdown and
...
class MempoolPersistTest(ZenacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent zenacoind from writing mempool.dat to disk. Verify that `savemempool` fails")
