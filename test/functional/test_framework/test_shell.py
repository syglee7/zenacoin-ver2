...
class TestShell:
    """Wrapper Class for ZenacoinTestFramework.

    The TestShell class extends the ZenacoinTestFramework
    ...
    class __TestShell(ZenacoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ZenacoinTestFramework child class.
            self.num_nodes = 1
