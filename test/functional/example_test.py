...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ZenacoinTestFramework
    pass


class ExampleTest(ZenacoinTestFramework):
    # Each functional test is a subclass of the ZenacoinTestFramework class.
    ...
    def custom_method(self):
        ...
        ZenacoinTestFramework class so other tests can use it."""
