...
"""Verify that starting zenacoin with -h works as expected."""

from test_framework.test_framework import ZenacoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ZenacoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start zenacoin with -h for help text")
        ...
        self.log.info("Start zenacoin with -version for version information")
        ...
        self.log.info("Start zenacoind with -fakearg to make sure it does not start")
