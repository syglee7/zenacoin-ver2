...
class P2PPermissionsTests(ZenacoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].zenacoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].zenacoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
