...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Zenacoin
else
  DOCKER_EXEC echo \> \$HOME/.zenacoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/zenacoin/zenacoin/pull/18288#discussion_r433189350 for
  # details.
